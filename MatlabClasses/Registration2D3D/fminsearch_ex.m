function [x,fval,exitflag,output] = fminsearch_ex(funfcn,x,options,usual_delta,zero_term_delta,varargin)
...
% usual_delta = 0.40;             % 20 percent deltas for non-zero terms
% zero_term_delta = 0.30;      % Even smaller delta for zero elements of x
